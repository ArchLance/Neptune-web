<template>
  <div class="set">
    ...
    <p>
      ...
      <el-form ref="toBindFormRef" status-icon :model="state.toBind" class="demo-form-inline">
        <el-row :gutter="20">
          <el-col :span="12" v-show="showGetCode && !showNewEmail">
            <el-form-item prop="code" style="width: 100%;">
              <el-input v-model="state.toBind.code" placeholder="请输入邮箱验证码">
                <template #append>
                  <el-button type="primary" plain @click="getCode(0)" color="#2fa7b9" :disabled="!show">{{ codeText
                    }}</el-button>
                </template>
              </el-input>
            </el-form-item>
          ...
          <el-col :span="8" v-show="showNewEmail && !showGetCode">
            <el-form-item prop="code2" style="width: 100%;">
              <el-input v-model="state.toBind.code2" placeholder="请输入新邮箱验证码">
                <template #append>
                  <el-button type="primary" plain @click="getCode(1)" color="#2fa7b9" :disabled="!show">{{ codeText
                    }}</el-button>
                </template>
              </el-input>
            </el-form-item>
